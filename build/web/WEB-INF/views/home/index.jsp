<%-- 
    Document   : index
    Created on : Jun 7, 2022, 7:29:56 AM
    Author     : PHT
--%>
...
<body>
        ...
        <header class="w3-display-container w3-content" style="max-width:1500px;">
            <img class="w3-image" src="<c:url value="/images/background.jpg" />" alt="The Hotel" style="min-width:1000px" width="100%"
                 height="800">
            <div class="w3-display-left w3-padding w3-col l6 m8">
                <div class="w3-container w3-red">
                    <h2><i class="fa fa-bed w3-margin-right"></i>Apartment Name</h2>
                </div>
        ...
        <div class="w3-content" style="max-width:1532px;">
            ...
            <div class="w3-row-padding w3-padding-16">
                <div class="w3-third w3-margin-bottom">
                    <img src="<c:url value="/images/rooms1.jpg" />"" alt="Norway" style="width:100%">
                    <div class="w3-container w3-white">
                        ...
                        <p class="w3-large"><i class="fa fa-bath"></i> <i class="fa fa-phone"></i> <i
                                class="fa fa-wifi"></i></p>
                        <button class="w3-button w3-block w3-black w3-margin-bottom">Choose Room</button>
                    </div>
                </div>
                <div class="w3-third w3-margin-bottom">
                    <img src="<c:url value="/images/rooms2.jpg" />" alt="Norway" style="width:100%">
                    <div class="w3-container w3-white">
                        <h3>Double Room</h3>
                        ...
                        <p>25m<sup>2</sup></p>
                        <p class="w3-large"><i class="fa fa-bath"></i> <i class="fa fa-phone"></i> <i
                                class="fa fa-wifi"></i> <i class="fa fa-tv"></i></p>
                        <button class="w3-button w3-block w3-black w3-margin-bottom">Choose Room</button>
                    </div>
                </div>
                <div class="w3-third w3-margin-bottom">
                    <img src="<c:url value="/images/rooms3.jpg" />" alt="Norway" style="width:100%">
                    <div class="w3-container w3-white">
                        <h3>Deluxe Room</h3>
                        ...
                        <p>40m<sup>2</sup></p>
                        <p class="w3-large"><i class="fa fa-bath"></i> <i class="fa fa-phone"></i> <i
                                class="fa fa-wifi"></i> <i class="fa fa-tv"></i> <i class="fa fa-glass"></i> <i
            ...
            <div class="w3-row-padding" id="about">
                <div class="w3-col l4 12">
                    ...
                    <p>We accept: <i class="fa fa-credit-card w3-large"></i> <i class="fa fa-cc-mastercard w3-large"></i> <i
                            class="fa fa-cc-amex w3-large"></i> <i class="fa fa-cc-cc-visa w3-large"></i><i
                            class="fa fa-cc-paypal w3-large"></i></p>
                </div>
                <div class="w3-col l8 12">
                    <!-- Image of location/map -->
                    <img src=" <c:url value="/images/location.jpg" />" class="w3-image w3-greyscale" style="width:100%;">
                </div>
            </div>
            ...
            <div class="w3-container">
                <h3>Our Partners</h3>
                <h6>We have cooperated and succeeded for 5 years:</h6>
            </div>

            <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
                <div class="w3-half w3-margin-bottom">
                    <div class="w3-display-container">
                        <img src=<c:url value="/images/lotte.jpg" /> alt="Cinque Terre" style="width:80%">
                    </div>
                </div>
                <div class="w3-half">
                    <div class="w3-row-padding" style="margin:0 -16px">
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="<c:url value="/images/masterise.jpg" />" alt="New York" style="width:100%">
                            </div>
                        </div>
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="<c:url value="/images/Nova.jpg" />" alt="va.jpg"San Francisco" style="width:100%">
                            </div>
                        </div>
                    </div>
                    <div class="w3-row-padding" style="margin:0 -16px">
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="<c:url value="/images/vinhome.jpg" />" alt="Pisa" style="width:100%">
                            </div>
                        </div>
                        <div class="w3-half w3-margin-bottom">
                            <div class="w3-display-container">
                                <img src="<c:url value="/images/3caynhang.jpg" />"  alt="Paris" style="width:100%">
                            </div>
                        </div>
                    </div>
                </div>
